...
def main():
    ...
    parser.add_argument('-d', action='store', dest='dir', help='/path/to/root/dir',
                        metavar="DIR", default='~/Project/SNuPer_results')
    ...
    if not args.plot:
        ...
        print("Exiting")
            ...
            print('{} points above log2 0 plotted out of {} possible SNP-ORFs'
                  ' found within given cutoffs'.format(len(top), len(SNPs)))
